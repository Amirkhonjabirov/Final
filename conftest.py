...
def pytest_addoption(parser):
    ...
    parser.addoption("--exec", action="store", default="172.25.144.1")
    # parser.addoption("--brow_version", default="108.0")
...
def executer(request):
    ...
    execut = request.config.getoption("--exec")
    # brw_version = request.config.getoption("--brow_version")
    ...
    if execut == "local":
        ...
        driver = webdriver.Remote(
            command_executor=f"http://{execut}:4444/wd/hub",
